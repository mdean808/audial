...
import { p as N, t as j, B as z } from '../../chunks/Button-88d2cbd5.js';
  ...
  return (
    ...
    a.$on('click', u[5]),
    {
      c() {
        (t = h('div')),
          (e = h('div')),
          (s = S('paste the link to any spotify playlist below')),
          (o = G()),
          (l = h('input')),
          (r = G()),
          (i = h('div')),
      ...
      l(f) {
        ...
        e = k(m, 'DIV', { class: !0 });
        var g = v(e);
        (s = q(g, 'paste the link to any spotify playlist below')),
          g.forEach(p),
          (o = P(m)),
          (l = k(m, 'INPUT', { class: !0, name: !0, placeholder: !0 })),
          (r = P(m)),
          (i = k(m, 'DIV', { class: !0 }));
        var B = v(i);
        I(a.$$.fragment, B), B.forEach(p), m.forEach(p), this.h();
      },
      h() {
      ...
      m(f, m) {
        $(f, t, m),
          ...
          D(a, i, null),
          (c = !0),
          n || ((V = R(l, 'input', u[4])), (n = !0));
      },
      p(f, m) {
        m & 1 && l.value !== f[0] && L(l, f[0]);
        const g = {};
        m & 128 && (g.$$scope = { dirty: m, ctx: f }), a.$set(g);
      },
      i(f) {
        c || (d(a.$$.fragment, f), (c = !0));
      },
      o(f) {
        _(a.$$.fragment, f), (c = !1);
      },
...
function et(u) {
  ...
  return {
    c() {
      t = S('start your custom audial');
    },
    l(e) {
      t = q(e, 'start your custom audial');
    },
    m(e, s) {
      $(e, t, s);
    },
...
function at(u) {
  let t, e, s, o, l;
  return (
    (e = new W({ props: { custom: !0, random: !1 } })),
...
function lt(u, t, e) {
  let s, o;
  C(u, N, n => e(6, (s = n))), C(u, Q, n => e(2, (o = n)));
  let l = '',
    r = !1;
  N.subscribe(n => {
  ...
  const i = async n => {
    ...
    (n = n || new URL(l).pathname.split('/')[2]),
      await T('/custom?playlist=' + n),
      e(1, (r = !0)),
      J.set({ attempts: 0, type: 'custom', guesses: [], date: new Date(), correct: !1 }),
      await O(n, !1);
  };
  function a() {
    (l = this.value), e(0, l);
